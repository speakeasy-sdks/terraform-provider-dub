...
type RetrieveAnalyticsResponseBody struct {
	ClicksCount             *shared.ClicksCount
	ArrayOfClicksTimeseries []shared.ClicksTimeseries
	ArrayOfClicksCountries  []shared.ClicksCountries
	ArrayOfClicksCities     []shared.ClicksCities
	ArrayOfClicksDevices    []shared.ClicksDevices
	ArrayOfClicksBrowsers   []shared.ClicksBrowsers
	ArrayOfClicksOS         []shared.ClicksOS
	ArrayOfClicksReferers   []shared.ClicksReferers
	ArrayOfClicksTopLinks   []shared.ClicksTopLinks
	ArrayOfClicksTopUrls    []shared.ClicksTopUrls
	LeadsCount              *shared.LeadsCount
	ArrayOfLeadsTimeseries  []shared.LeadsTimeseries
	ArrayOfLeadsCountries   []shared.LeadsCountries
	ArrayOfLeadsCities      []shared.LeadsCities
	ArrayOfLeadsDevices     []shared.LeadsDevices
	ArrayOfLeadsBrowsers    []shared.LeadsBrowsers
	ArrayOfLeadsOS          []shared.LeadsOS
	ArrayOfLeadsReferers    []shared.LeadsReferers
	ArrayOfLeadsTopLinks    []shared.LeadsTopLinks
	ArrayOfLeadsTopUrls     []shared.LeadsTopUrls
	SalesCount              *shared.SalesCount
	ArrayOfSalesTimeseries  []shared.SalesTimeseries
	ArrayOfSalesCountries   []shared.SalesCountries
	ArrayOfSalesCities      []shared.SalesCities
	ArrayOfSalesDevices     []shared.SalesDevices
	ArrayOfSalesBrowsers    []shared.SalesBrowsers
	ArrayOfSalesOS          []shared.SalesOS
	ArrayOfSalesReferers    []shared.SalesReferers
	ArrayOfSalesTopLinks    []shared.SalesTopLinks
	ArrayOfSalesTopUrls     []shared.SalesTopUrls

	Type RetrieveAnalyticsResponseBodyType
}

func CreateRetrieveAnalyticsResponseBodyClicksCount(clicksCount shared.ClicksCount) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksTimeseries(arrayOfClicksTimeseries []shared.ClicksTimeseries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksCountries(arrayOfClicksCountries []shared.ClicksCountries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksCities(arrayOfClicksCities []shared.ClicksCities) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksDevices(arrayOfClicksDevices []shared.ClicksDevices) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksBrowsers(arrayOfClicksBrowsers []shared.ClicksBrowsers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksOS(arrayOfClicksOS []shared.ClicksOS) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksReferers(arrayOfClicksReferers []shared.ClicksReferers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksTopLinks(arrayOfClicksTopLinks []shared.ClicksTopLinks) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfClicksTopUrls(arrayOfClicksTopUrls []shared.ClicksTopUrls) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyLeadsCount(leadsCount shared.LeadsCount) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsTimeseries(arrayOfLeadsTimeseries []shared.LeadsTimeseries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsCountries(arrayOfLeadsCountries []shared.LeadsCountries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsCities(arrayOfLeadsCities []shared.LeadsCities) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsDevices(arrayOfLeadsDevices []shared.LeadsDevices) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsBrowsers(arrayOfLeadsBrowsers []shared.LeadsBrowsers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsOS(arrayOfLeadsOS []shared.LeadsOS) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsReferers(arrayOfLeadsReferers []shared.LeadsReferers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsTopLinks(arrayOfLeadsTopLinks []shared.LeadsTopLinks) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfLeadsTopUrls(arrayOfLeadsTopUrls []shared.LeadsTopUrls) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodySalesCount(salesCount shared.SalesCount) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesTimeseries(arrayOfSalesTimeseries []shared.SalesTimeseries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesCountries(arrayOfSalesCountries []shared.SalesCountries) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesCities(arrayOfSalesCities []shared.SalesCities) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesDevices(arrayOfSalesDevices []shared.SalesDevices) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesBrowsers(arrayOfSalesBrowsers []shared.SalesBrowsers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesOS(arrayOfSalesOS []shared.SalesOS) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesReferers(arrayOfSalesReferers []shared.SalesReferers) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesTopLinks(arrayOfSalesTopLinks []shared.SalesTopLinks) RetrieveAnalyticsResponseBody {
...
func CreateRetrieveAnalyticsResponseBodyArrayOfSalesTopUrls(arrayOfSalesTopUrls []shared.SalesTopUrls) RetrieveAnalyticsResponseBody {
...
func (u *RetrieveAnalyticsResponseBody) UnmarshalJSON(data []byte) error {
	...
	var leadsCount shared.LeadsCount = shared.LeadsCount{}
	...
	var clicksCount shared.ClicksCount = shared.ClicksCount{}
	...
	var salesCount shared.SalesCount = shared.SalesCount{}
	...
	var arrayOfLeadsDevices []shared.LeadsDevices = []shared.LeadsDevices{}
	...
	var arrayOfLeadsOS []shared.LeadsOS = []shared.LeadsOS{}
	...
	var arrayOfClicksBrowsers []shared.ClicksBrowsers = []shared.ClicksBrowsers{}
	...
	var arrayOfClicksOS []shared.ClicksOS = []shared.ClicksOS{}
	...
	var arrayOfClicksReferers []shared.ClicksReferers = []shared.ClicksReferers{}
	...
	var arrayOfClicksTopLinks []shared.ClicksTopLinks = []shared.ClicksTopLinks{}
	...
	var arrayOfClicksTopUrls []shared.ClicksTopUrls = []shared.ClicksTopUrls{}
	...
	var arrayOfClicksCities []shared.ClicksCities = []shared.ClicksCities{}
	...
	var arrayOfLeadsTimeseries []shared.LeadsTimeseries = []shared.LeadsTimeseries{}
	...
	var arrayOfLeadsCountries []shared.LeadsCountries = []shared.LeadsCountries{}
	...
	var arrayOfLeadsCities []shared.LeadsCities = []shared.LeadsCities{}
	...
	var arrayOfClicksCountries []shared.ClicksCountries = []shared.ClicksCountries{}
	...
	var arrayOfLeadsBrowsers []shared.LeadsBrowsers = []shared.LeadsBrowsers{}
	...
	var arrayOfClicksDevices []shared.ClicksDevices = []shared.ClicksDevices{}
	...
	var arrayOfLeadsReferers []shared.LeadsReferers = []shared.LeadsReferers{}
	...
	var arrayOfLeadsTopLinks []shared.LeadsTopLinks = []shared.LeadsTopLinks{}
	...
	var arrayOfLeadsTopUrls []shared.LeadsTopUrls = []shared.LeadsTopUrls{}
	...
	var arrayOfClicksTimeseries []shared.ClicksTimeseries = []shared.ClicksTimeseries{}
	...
	var arrayOfSalesTimeseries []shared.SalesTimeseries = []shared.SalesTimeseries{}
	...
	var arrayOfSalesCountries []shared.SalesCountries = []shared.SalesCountries{}
	...
	var arrayOfSalesCities []shared.SalesCities = []shared.SalesCities{}
	...
	var arrayOfSalesDevices []shared.SalesDevices = []shared.SalesDevices{}
	...
	var arrayOfSalesBrowsers []shared.SalesBrowsers = []shared.SalesBrowsers{}
	...
	var arrayOfSalesOS []shared.SalesOS = []shared.SalesOS{}
	...
	var arrayOfSalesReferers []shared.SalesReferers = []shared.SalesReferers{}
	...
	var arrayOfSalesTopLinks []shared.SalesTopLinks = []shared.SalesTopLinks{}
	...
	var arrayOfSalesTopUrls []shared.SalesTopUrls = []shared.SalesTopUrls{}
...
func (o *RetrieveAnalyticsResponse) GetBadRequest() *shared.BadRequest {
	if o == nil {
		return nil
	}
	return o.BadRequest
...
func (o *RetrieveAnalyticsResponse) GetUnauthorized() *shared.Unauthorized {
	if o == nil {
		return nil
	}
...
func (o *RetrieveAnalyticsResponse) GetForbidden() *shared.Forbidden {
	if o == nil {
		return nil
	}
	return o.Forbidden
...
func (o *RetrieveAnalyticsResponse) GetNotFound() *shared.NotFound {
	if o == nil {
		return nil
	}
	return o.NotFound
...
func (o *RetrieveAnalyticsResponse) GetConflict() *shared.Conflict {
	if o == nil {
		return nil
	}
	return o.Conflict
...
func (o *RetrieveAnalyticsResponse) GetInviteExpired() *shared.InviteExpired {
	if o == nil {
		return nil
	}
...
func (o *RetrieveAnalyticsResponse) GetUnprocessableEntity() *shared.UnprocessableEntity {
	if o == nil {
		return nil
	}
...
func (o *RetrieveAnalyticsResponse) GetRateLimitExceeded() *shared.RateLimitExceeded {
	if o == nil {
		return nil
	}
...
func (o *RetrieveAnalyticsResponse) GetInternalServerError() *shared.InternalServerError {
	if o == nil {
		return nil
	}
